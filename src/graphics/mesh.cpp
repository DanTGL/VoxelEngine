...
unsigned int Mesh::AddVertex(glm::vec3 pos, glm::vec3 normal,
                             glm::vec2 texcoord, float layer) {
  Vertex vertex;
  vertex.Position = pos;
...
void Mesh::AddTriangle(unsigned int vertex1, unsigned int vertex2,
...
void AddTexture(std::string imagepath) {
  ...
  // "Bind" the newly created texture : all future functions will modify this
  // texture
